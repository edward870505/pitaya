...
Page({
  ...
  data: {
    ...
    itemImgSrc: '/images/form_label_imgs/汇率.png',
    filterData: {
      initText: '请选择目标币种',
      text: '',
      imgSrc: '/images/form_label_imgs/currency.png',//筛选框右侧图标,
      range: []
    },
    operations: [
      {
  ...
  onLoad: function (options) {
    ...
    /*初始化筛选框Range*/
    this.data.filterData.range = ['全部', '人民币', '越南盾','美金'];
    this.setData({
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'exchangerates';
  ...
  * **/
  onSwitchValueChanged: function (e) {
    util.operation.page.onSwitchValueChanged(e, this, { repeated: false }, {}, {}, 'exchangerates');
  },
  /***
* 
*/

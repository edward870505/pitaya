...
Page({
  ...
  data: {
    itemName: 'farming',
    itemImgSrc: '/images/form_label_imgs/farming-1.png',
    filterData: {
      initText: '请选择农事类型',
      text: '',
      imgSrc: '/images/form_label_imgs/farming.png',//筛选框右侧图标,
      range: []
    },
    operations: [
      {
  ...
  onLoad: function (options) {
    ...
    /*初始化筛选框Range*/
    this.data.filterData.range = ['全部', '产出型', '非产出型'];
    this.setData({
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'farmings';
  ...
  * **/
  onSwitchValueChanged: function (e) {
    util.operation.page.onSwitchValueChanged(e, this, { repeated: false }, {}, {}, 'farmings');
  },
  /***
* 
*/

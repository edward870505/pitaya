...
Page({
   ...
   */
  data: {
    itemName:'field',//依据此值调用地块模板
    itemImgSrc:'/images/field.png',//记录标题图片
    filterData: {//筛选框参数
      initText:'请选择农场',
      text:'',
      imgSrc: '/images/农场.png',//筛选框右侧图标,
      range:[]
    },
    operations: [//操作对象数组
      {
        imgSrc: '/images/add_btn.png',//新增操作按钮
        text: '新增地块',//新增操作文本
        action: 'add'//操作标记值
      }
    ],
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'fields';
 ...
 * **/
  onSwitchValueChanged:function(e){
    util.operation.page.onSwitchValueChanged(e,this,{repeated:false},{},{},'fields');
  },
/**

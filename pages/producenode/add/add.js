...
* **/
  submitAddForm: function () {
    var dataset, type, name, desc, producenode, data, page;
    page = this;
    data = {};
    producenode = {};
    dataset = this.data.dataset;

    producenode.type = dataset.type.value;
    producenode.name = dataset.name.value;
    producenode.desc = dataset.desc.value;

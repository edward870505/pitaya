// pages/producenode/producenode.js
...
Page({
  ...
  */
  data: {
    ...
    itemImgSrc: '/images/node-2.png',
    filterData: {
        initText: '请选择流程类型',
        text: '',
        imgSrc: '/images/node-1.png',//筛选框右侧图标,
        range: []
    },
    operations: [
        {
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'producenodes';
 ...
 * **/
  onSwitchValueChanged: function (e) {
    util.operation.page.onSwitchValueChanged(e, this, { repeated: false },{},{},'producenodes');
  },
  /**

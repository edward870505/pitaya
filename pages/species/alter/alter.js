 ...
 * **/
  ...
  * **/
  ...
  submitAlterForm: function () {
    var dataset, type, name, desc, species, data;
    data = {};
    species = {};
    dataset = this.data.dataset;
    species.type = dataset.type;
    species.name = dataset.name;
    species.desc = dataset.desc;

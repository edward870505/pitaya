...
Page({
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'species';
...
* **/
  ...
  * **/
  onSwitchValueChanged: function (e) {
    var index, type, name, keys, species, collectionName;
    collectionName = 'species';
    species = {};
    index = e.currentTarget.dataset.index;

    species.type = this.data.dataset[index].type;
    species.name = this.data.dataset[index].name;
    species.status = true;

    keys = ['type', 'name', 'status'];

    util.operation.page.onSwitchValueChanged(e, this, { repeated: true }, species, keys, 'species');
  },
  /***
* 
*/

...
Page({
  ...
  data: {
    ...
    itemName: 'transfer',
    itemImgSrc: '/images/转换关系.png',
    filterData: {
      initText: '请选择目标单位种类',
      text: '',
      imgSrc: '/images/转换-1.png',//筛选框右侧图标,
      range: []
    },
    operations: [
      {
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'transfers';
 ...
 * **/
  onSwitchValueChanged: function (e) {
    util.operation.page.onSwitchValueChanged(e, this, { repeated: false }, {}, {}, 'transfers');
  },
  /**

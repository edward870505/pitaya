...
Page({
  ...
  data: {
    ...
    itemName: 'unit',
    itemImgSrc: '/images/计量单位.png',
    filterData: {
      initText: '请选择单位类型',
      text: '',
      imgSrc: '/images/form_label_imgs/计量单位.png',//筛选框右侧图标,
      range: []
    },
    operations: [
      {
  ...
  onLoad: function (options) {
    ...
    appInstance.dbData.unitTypes.forEach(function(item,index){
      page.data.filterData.range.push(item);
    });
    this.setData({
  ...
  onShow: function () {
    ...
    //数据库查询操作参数设置
    queryData.collectionName = 'units';
...
* **/
  onSwitchValueChanged: function (e) {
    util.operation.page.onSwitchValueChanged(e, this, { repeated: false }, {}, {}, 'units');
  },
  /***
* 
*/
